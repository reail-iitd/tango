...
dict_of_predicates = json.load(open("jsons/predicates_for_webapp.json"))["dict_of_predicates"]

# Mapping of user action to the simulator action.
dict_predicate_to_action = json.load(open("jsons/predicates_for_webapp.json"))["dict_predicate_to_action"]

# The list of goals that are possible for the simulator to execute.
GOAL_LIST = json.load(open("jsons/predicates_for_webapp.json"))["GOAL_LIST"]

# The list of world instances that can be loaded by the simulator.
WORLD_LIST = json.load(open("jsons/predicates_for_webapp.json"))["WORLD_LIST"]
